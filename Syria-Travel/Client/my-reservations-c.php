...
<section class="section-wrapper intro">
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills">
            <li><a href="my-reservations.php"> On Hold </a></li>
            <li  class="active"><a href="#"> Confirmed </a></li>
    ...
    <div id="header" class="container">
        ...
        t_company_id = c_id AND r_client_id = " . $client_id . " AND  r_status='confirmed' AND t_status not in ('arrived', 'canceled')";
