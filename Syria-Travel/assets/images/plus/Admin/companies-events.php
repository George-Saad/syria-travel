...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Companies Events </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `companies`, `event_history` WHERE c_id = event_actor_id AND event_action in 
                        ('add_trip','update_trip', 'add_employee', 'remove_employee') ORDER  BY event_date, event_time DESC ";
                ...
                while ($row= mysqli_fetch_assoc($result)){
                    echo '<tr>
                            ...
                            <th>
                                <a href="company-events.php?id=' . $row["c_id"]  .'"> <button type="button" class="btn-sm btn-default">
                                    <strong class="text-info"> ' . $row["c_name"] . ' Events </strong></button>
                                </a>
                            </th>
                        </tr> 
