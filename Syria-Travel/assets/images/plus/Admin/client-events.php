...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Client Events </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `clients`, `event_history` WHERE client_id = event_actor_id AND client_id = " . $_GET['id'] . " AND event_action in 
