...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Employees Logs </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `employee`, `event_history` WHERE e_comapny_id = " . $_SESSION['c_id'] . " and e_id = event_actor_id AND event_action in 
                        ('e_login','e_logout') ORDER  BY event_date, event_time DESC ";
                ...
                while ($row= mysqli_fetch_assoc($result)){
                    echo '<tr>
                            ...
                            <th>
                                <a href="employee-logs.php?id=' . $row["e_id"]  .'"> <button type="button" class="btn-sm btn-default">
                                    <strong class="text-info"> ' . $row["e_username"] . ' Logs </strong></button>
                                </a>
                            </th>
                        </tr> 
