...
$query= "SELECT * from reservations,trip_info WHERE r_trip_id=t_id and r_status='hold' and t_company_id=" . $e_company_id;
$result= mysqli_query($conn,$query);
...
while ($row= mysqli_fetch_assoc($result)){
    ...
    echo '<tr>
                            ...
                            <th>
                                ...
                                <a href="confirm.php?r_id='. $row['r_id'] .'"><button type="button" class="btn-sm  btn-success"> Confirm </button></a>
                                <a href="#"><button type="button" class="btn-sm  btn-danger void" id="' . $row['r_id'] . '" onclick="showAlert(this.id)" > Void </button></a>
                            </th>
                         </tr>
                        <tr>
