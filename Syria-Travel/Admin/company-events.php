...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Company Events </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `companies`, `event_history` WHERE c_id = event_actor_id AND c_id = " . $_GET['id'] . " AND event_action in 
