...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Employee Events </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `Employee`, `event_history` WHERE e_id = event_actor_id AND e_id = " . $_GET['id'] . " AND event_action in 
