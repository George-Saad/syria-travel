...
$query = "select * from employee  where e_id = " . $_GET['id'];
...
?>
    <section id="header" class="section-wrapper intro">
        <div class="container">
            <h1 class="text-left text-muted"> Employee Logs </h1>
            <hr>
        ...
        <div class="container">
            <table class="table" style="color: black">
                ...
                <thead>
                <?php
                $query= "SELECT * FROM `employee`, `event_history` WHERE e_id = " . $_GET['id'] . " and e_id = event_actor_id AND event_action in 
