...
<section id="header" class="section-wrapper intro">
    <div class="container">
        <h1 class="text-left text-muted"> Unavailable Trips </h1>
        <hr>
    ...
    <div class="container">
        ...
        <table class="table" style="color: black">
            ...
            <tr>
                ...
                <th>
                    <form method="post" action="unavailable-trips.php">
            ...
            if (isset($_POST['search'])){
                $search=$_POST['search'];
                $query="SELECT * from trip_info WHERE (t_company_id = " . $_SESSION['c_id'] . ") AND (t_status = 'unavailable') AND 
                        ((t_from like '%" . $search . "%') OR (t_to like '%" . $search . "%') ) order by t_departure_date desc";
            }
            else
            {
                $query= "select * from trip_info WHERE t_company_id=" . $_SESSION['c_id'] . " and t_status = 'unavailable' order by t_departure_date desc";
            }
